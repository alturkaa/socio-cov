...
# ---- Map for Per Capita Cases and Growth Rates
...
capturePlot(legend, filename = 'legend.html', width = 175, height = 175)
...
> Notes: Does not include cases not assigned to counties.</br>3X3 bivariate choropleths use Fisher-Jenks breaks.
