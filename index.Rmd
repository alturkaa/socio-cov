...
extra_vars <- c('B09021_023', 'B27010_051', 'B19083_001', 'B16010_041', 'B16010_001')
...
clean_df <- condensed_df %>% 
  ...
  mutate('Percent Population 65 and Above' = prop_65_above * 100,
         ...
         'People Living in Nursing Homes per 1K' = P042005 / (P001001 / 1000),
         'People Living in Correctional Facilities per 1K' = P042003 / (P001001 / 1000),
...
**Median:** `r round(growth_median, 1)`</br>
**75th Percentile:** `r round(growth_p75, 1)`
